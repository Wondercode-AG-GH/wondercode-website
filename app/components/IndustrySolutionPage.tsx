    ...
    >
      ...
      <div className="fixed top-24 right-8 z-50 flex gap-2">
        <motion.button
          ...
          style={{
            backgroundColor:
              i18n.language === "en" ? accentColor : "rgba(255, 255, 255, 0.1)",
            color: i18n.language === "en" ? "#050505" : "#CCCCCC",
          }}
        >
          EN
        </motion.button>
        <motion.button
          ...
          style={{
            backgroundColor:
              i18n.language === "de" ? accentColor : "rgba(255, 255, 255, 0.1)",
            color: i18n.language === "de" ? "#050505" : "#CCCCCC",
          }}
        >
          DE
        </motion.button>
                  ...
                  >
                    ...
                    >
                      <span
                        ...
                        style={{ color: isAI ? accentColor : "#FFFFFF" }}
                      >
                        {i18n.language === "en" ? step.label : step.labelDe}
                      </span>
