      ...
      >
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            >
              ...
              >
                <div
                  ...
                  style={{ color: "#00CC66" }}
                >
                  {i18n.language === "en" ? timelineLabel : timelineLabelDe}
                </div>
            ...
            >
              <div
                className="p-8 lg:p-12 rounded-3xl backdrop-blur-xl border"
                style={{
                ...
                >
                  ...
                  >
                    ...
                    <h3
                      ...
                      style={{ color: "white" }}
                    >
                      {i18n.language === "en" ? pillar.title : pillar.titleDe}
                    </h3>
          ...
          >
            <div className="mb-8">
              <svg
                ...
                style={{ color: "#00CC66", opacity: 0.3 }}
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <blockquote
              className="text-2xl lg:text-4xl font-light leading-relaxed mb-12 italic"
              style={{ color: "white" }}
            >
              "{i18n.language === "en" ? testimonialQuote : testimonialQuoteDe}"
            </blockquote>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                ...
                <div className="text-base" style={{ color: "#00CC66" }}>
                  {i18n.language === "en" ? testimonialRole : testimonialRoleDe}
                </div>
              </div>
            </div>
          </motion.div>
