...
export default function Footer() {
  const services = ['Salesforce Consulting', 'AI Strategy', 'Custom Web Apps', 'Agentforce Implementation'];
  const company = ['About Us', 'Careers', 'Blog', 'Contact'];
  const legal = ['Privacy Policy', 'Terms of Service', 'Cookie Policy', 'Imprint'];

  return (
    <footer className="relative bg-[#0A0A0A] border-t border-white/10 pt-12 md:pt-20 pb-10 px-5 md:px-8" style={{ position: 'relative' }}>
      <div className="max-w-[1600px] mx-auto" style={{ position: 'relative' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 mb-12 md:mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed max-w-sm">
              Empowering Swiss businesses with intelligent Salesforce architectures, cutting-edge AI strategies, and bespoke web solutions.
            </p>
            ...
            >
              ...
              <div>
                <div className="text-sm font-semibold text-white">Zürich (HQ)</div>
                <div className="text-xs text-gray-500">Schweiz</div>
              </div>
            </motion.div>

            {/* Language Switcher in Footer */}
            <div className="mb-4">
              <p className="text-xs text-gray-500 mb-2">Language / Sprache</p>
              <LanguageSwitcher />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service}>
                  <a href="#" className="text-gray-400 hover:text-[#00CC66] transition-colors text-sm">
                    {service}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:hello@wondercode.ch" className="flex items-center gap-3 text-gray-400 hover:text-[#00CC66] transition-colors text-sm group">
                  <Mail className="w-4 h-4 text-[#00CC66] group-hover:scale-110 transition-transform" />
                  hello@wondercode.ch
                </a>
              </li>
              <li>
                <a href="tel:+41445550100" className="flex items-center gap-3 text-gray-400 hover:text-[#00CC66] transition-colors text-sm group">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-sm text-gray-500">
            © {new Date().getFullYear()} Wondercode AG. All rights reserved.
          </div>
