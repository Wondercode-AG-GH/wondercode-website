...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1600px] mx-auto px-5 md:px-8 lg:px-12" style={{ position: 'relative' }}>
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden lg:flex items-center gap-10">
              {['Services', 'Agentforce', 'Custom Engineering', 'Industry Expertise', 'Success Stories', 'About'].map((item, i) => (
                <motion.a
                  key={item}
