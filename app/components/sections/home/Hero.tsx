  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          position: 'absolute',
          background: 'radial-gradient(ellipse 900px 700px at center 35%, rgba(5, 5, 5, 0.5) 0%, transparent 65%)',
        }}
      />
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-5 md:px-8 text-center">
          ...
          >
            ...
            />
            <span className="text-xs md:text-sm font-medium" style={{ color: '#00CC66' }}>Swiss Precision × Silicon Valley Innovation</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-base md:text-xl lg:text-2xl mb-8 md:mb-12 max-w-5xl mx-auto leading-relaxed"
            style={{ color: '#999999' }}
          >
            Wachstum erzeugt Chaos, wenn Systeme fehlen. Wir implementieren das digitale Rückgrat, 
            das Ihre gesamte Customer Journey automatisiert – vom ersten Klick bis zum Service-Ticket.{' '}
            <span style={{ color: '#00CC66' }}>In 4 Wochen startklar.</span>
          </motion.p>
          ...
          >
            ...
            >
              <span className="relative z-10">Zum System-Check</span>
