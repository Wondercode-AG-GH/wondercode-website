...
export default function AboutUs() {
  ...
  const coreValues = [
    {
      icon: Shield,
      title: 'Trust',
      description: 'Swiss precision and reliability in every project'
    },
    {
      icon: Rocket,
      title: 'Innovation',
      description: 'Cutting-edge solutions that drive results'
    },
    {
      icon: Handshake,
      title: 'Partnership',
      description: 'Long-term relationships built on success'
    }
  ];
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-5 md:px-8 relative" style={{ position: 'relative' }}>
      {/* Bento Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 relative" style={{ position: 'relative' }}>
          ...
          <div className="relative h-full p-10 lg:p-14 rounded-3xl bg-white/[0.02] border border-white/10 hover:border-[#00CC66]/40 backdrop-blur-xl transition-all duration-500 overflow-hidden min-h-[400px] flex flex-col justify-center">
            ...
            <div className="relative z-10">
              ...
              >
                Human Strategy,
                <br />
                <span className="text-[#00CC66]">Intelligent Code</span>
              </motion.h2>
              ...
              <motion.p
                ...
                style={{ position: 'relative' }}
              >
                We merge the precision and reliability of Swiss engineering with the transformative power 
                of artificial intelligence. Our team of strategists, engineers, and AI specialists doesn't 
                just implement technology—we architect solutions that elevate your entire organization.
              </motion.p>
              ...
              >
                <div>
                  <div className="text-4xl font-bold text-[#00CC66] mb-2">15+</div>
                  <div className="text-sm text-gray-500">Years Combined</div>
                </div>
                <div>
                ...
                <div>
                  <div className="text-4xl font-bold text-[#00CC66] mb-2">98%</div>
          ...
          <div className="relative h-full min-h-[400px] rounded-3xl bg-white/[0.02] border border-white/10 hover:border-[#00CC66]/60 backdrop-blur-xl transition-all duration-500 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 z-10">
              <motion.div
                ...
                style={{ position: 'relative' }}
              >
                <div className="text-sm text-[#00CC66] font-semibold mb-2 tracking-wider">THE FOUNDERS</div>
        ...
        >
          <div className="relative h-full p-8 lg:p-10 rounded-3xl bg-white/[0.02] border border-white/10 hover:border-[#00CC66]/40 backdrop-blur-xl transition-all duration-500 overflow-hidden">
            <div className="relative z-10">
              <h3 className="text-2xl font-bold mb-8 text-white" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
        ...
        >
          <div className="relative h-full p-8 lg:p-10 rounded-3xl bg-white/[0.02] border border-white/10 hover:border-[#00CC66]/40 backdrop-blur-xl transition-all duration-500 overflow-hidden min-h-[300px] flex flex-col">
            ...
            <div className="relative z-10 flex-1 flex flex-col">
              <h3 className="text-2xl font-bold mb-4 text-white" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
              ...
              <div className="flex-1 flex flex-col justify-center">
                ...
                <div ref={impactRef} className="mb-8">
                  ...
                  <div className="text-lg text-gray-400">Average Client Growth</div>
                </div>
