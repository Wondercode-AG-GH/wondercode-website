...
export default function Home() {
  return (
    <>
      ...
      <CaseStudiesGallery/>
       {/* About Us Section */}
      <section id="about" className="relative py-20 md:py-32 bg-[#0A0A0A] px-5 md:px-8" style={{ position: 'relative' }}>
        <div className="max-w-[1600px] mx-auto" style={{ position: 'relative' }}>
          ...
          >
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-[#00CC66]/10 border border-[#00CC66]/30 backdrop-blur-xl mb-8">
              ...
              <span className="text-sm font-medium text-[#00CC66]">WHO WE ARE</span>
            </div>
